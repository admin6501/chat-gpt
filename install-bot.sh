...
✅ ویژگی‌ها:
- پنل ادمین با تنظیمات فروشگاه:
  نام محصول، قیمت، شماره کارت، متن‌ها و زمان لغو سفارش‌ها
- لغو خودکار سفارش‌های پرداخت‌نشده پس از مدت قابل‌تنظیم
"""
...
async def admin_action(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "بازگشت":
        await update.message.reply_text("بازگشت به منوی ادمین.", reply_markup=admin_menu())
